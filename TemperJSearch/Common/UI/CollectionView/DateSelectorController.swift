...
class DateSelectorController: UICollectionViewController {

    private let viewModel = DateSelectorViewModel()
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(DaySelectorCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    }
